...
if __name__ == "__main__":
    ...
    if argv.diff_weights:
        ...
        __units__ = 50
        __state__ = 0
        excel_fname = './new-dataset/models/diff_weights/method-{}/hnn-mle-sigma-{}-nb_plays#-{}-units#-{}-__state__-{}.xlsx'.format(method, sigma, __nb_plays__, __units__, __state__)
    # else:
    ...
    for idx, nb_plays in enumerate(nb_plays_LIST):
        ...
        diff_frame = diff_frame.assign(outputs=_base_diff)
        ...
        for __activation__ in __activation__LIST:
            ...
            for ensemble in ensemble_LIST:
                ...
                #                                                                                     __activation__=__activation__, __state__=__state__, __units__=__units__, __nb_plays__=__nb_plays__, loss='mle', ensemble=ensemble)
                ...
                # import ipdb; ipdb.set_trace()
                # if diff_rmse2 < diff_rmse:
                #     diff_rmse = diff_rmse2
                # if argv.markov_chain:
                ...
                kwargs = {'nb_plays-{}-units-{}-__activation__-{}-__nb_plays__-{}-__units__-{}-ensemble-{}-diff'.format(nb_plays, units, __activation__, __nb_plays__, __units__, ensemble): (_predict_output[1:] - _predict_output[:-1])}
    ...
    writer.close()
    LOG.debug("write to excel fname: {}".format(excel_fname))
