...
DATASET_PATH = dict(
    ...
    models_diff_weights_trends_list=_prefix+'/models/diff_weights/method-{method}/activation-{activation}/state-{state}/mu-{mu}/sigma-{sigma}/units-{units}/nb_plays-{nb_plays}/points-{points}/input_dim-{input_dim}/predictions/activation#-{__activation__}/state#-{__state__}/units#-{__units__}/nb_plays#-{__nb_plays__}/loss-{loss}/ensemble-{ensemble}/trend.csv',
    ...
    lstm_diff_weights_mu_and_sigma=_prefix+'/lstm/diff_weights/method-{method}/activation-{activation}/state-{state}/input_dim-{input_dim}/mu-{mu}/sigma-{sigma}/units-{units}/nb_plays-{nb_plays}/points-{points}/units#-{__units__}/ensemble-{ensemble}/loss-{loss}/predict_mu_and_sigma.csv',
