...
#SBATCH -J run-rnn-pavel-sequence
#SBATCH -D /data/scratch/zxchen/fenv2
#SBATCH -o ./tmp/run-rnn-pavel-sequence-multiple-times-%a.log
#SBATCH --nodes=1
...
function run_pavel {
    ...
    python lstm/rnn_hysteretical.py --epochs 1000 --force_train --lr 0.001 --mu 0 --sigma 0 --units 50 --nb_plays 50 --points 1000 --__units__ ${__unit__} --method debug-pavel --loss mse --diff-weights --ensemble ${ensemble}
}
...
function run_dima {
    ...
    source /home/zxchen/.venv3/bin/activate
    python lstm/rnn_hysteretical.py --epochs 3000 --force_train --lr 0.001 --mu 0 --sigma 0 --units 50 --nb_plays 50 --points 1000 --__units__ ${__unit__} --method debug-dima --loss mse --diff-weights --ensemble ${ensemble}
}
