...
function run {
    ...
    python prove_hnn_mse_invertable.py --epochs 5000 --mu 0 --sigma ${sigma} --lr 0.1 --points 1000 --nb_plays 50 --units 50 --__nb_plays__ ${__nb_plays__} --__units__ ${__units__} --__activation__ elu --force_train --ensemble ${ensemble} --diff-weights --method debug-pavel
    # --activation tanh
}

run ${__nb_plays__LIST[SLURM_ARRAY_TASK_ID]} ${__units__LIST[SLURM_ARRAY_TASK_ID]} ${ensemble_LIST[SLURM_ARRAY_TASK_ID]}
